...
public class QuantumMiner extends AbstractProcessingMachine {
    ...
    protected void registerDefaultRecipes() {
        ...
        registerRecipe(15, ResourceItems.DENSE_CARBON_ALLOY, new ItemStack(Material.GOLD_ORE, 4));
        registerRecipe(15, ResourceItems.DENSE_CARBON_ALLOY, new ItemStack(Material.LAPIS_ORE, 8));
        registerRecipe(15, ResourceItems.DENSE_CARBON_ALLOY, new ItemStack(Material.REDSTONE, 12));
        ...
        registerRecipe(30, new ItemStack[] { ResourceItems.DENSE_CARBON_ALLOY },
        ...
        registerRecipe(40, new ItemStack[] { ResourceItems.ENERGIZED_PRISMARINE },
        ...
        registerRecipe(60, new ItemStack[] { ResourceItems.QUANTUM_CORE },
