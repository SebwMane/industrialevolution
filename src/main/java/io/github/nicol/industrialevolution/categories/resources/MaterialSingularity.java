...
public class MaterialSingularity {
        ...
        public static void setup(IndustrialEvolution plugin) {
                ...
                new SlimefunItem(CategorySetup.RESOURCES, MATTER_STABILIZER, io.github.nicol.industrialevolution.core.recipes.CoreRecipes.EVOLUTION_ALTAR_RECIPE,
                                new ItemStack[] {
                                                new ItemStack(Material.IRON_BLOCK), ResourceItems.QUANTUM_CORE,
                ...
                new SlimefunItem(CategorySetup.RESOURCES, UNSTABLE_SINGULARITY, RecipeType.NULL,
