...
public class ItemEthereal {
        ...
        public static void setup(IndustrialEvolution plugin) {
                ...
                new SlimefunItem(CategorySetup.INFINITY_ERA, ETHER_ESSENCE, RecipeType.ENHANCED_CRAFTING_TABLE,
                                new ItemStack[] {
                ...
                new SlimefunItem(CategorySetup.INFINITY_ERA, VIBRANIUM_CRYSTAL, RecipeType.ENHANCED_CRAFTING_TABLE,
                                new ItemStack[] {
                                                MaterialQuantum.DENSE_CARBON_ALLOY,
                                                MaterialSingularity.UNSTABLE_SINGULARITY,
                                                MaterialQuantum.DENSE_CARBON_ALLOY,
                                                SlimefunItems.REINFORCED_ALLOY_INGOT, new ItemStack(Material.NETHERITE_BLOCK),
                ...
                new SlimefunItem(CategorySetup.INFINITY_ERA, CHAOS_SHARD, RecipeType.ENHANCED_CRAFTING_TABLE,
                                new ItemStack[] {
                ...
                new SlimefunItem(CategorySetup.INFINITY_ERA, COSMIC_INGOT, RecipeType.ENHANCED_CRAFTING_TABLE,
                                new ItemStack[] {
                                                ETHER_ESSENCE, VIBRANIUM_CRYSTAL, CHAOS_SHARD,
                                                VIBRANIUM_CRYSTAL, MaterialQuantum.QUANTUM_CORE, VIBRANIUM_CRYSTAL,
